...
export default function MroeDashboard() {
  // --- INITIAL STATE ---
        ...
        <div className="lg:col-span-8 bg-slate-900/40 border border-slate-800 rounded-2xl p-4 flex flex-col justify-between relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3 relative z-10">
            {universes.map((u) => (
              <div 
                key={u.id} 
                className={`bg-gradient-to-b ${u.color} bg-opacity-10 border border-white/10 rounded-xl p-3 flex flex-col justify-between min-h-[220px] transition-all duration-300 hover:scale-105`}
              >
                <div>
          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-4 flex flex-col justify-between">
            ...
            <div className="space-y-2.5">
              ...
              <button 
                ...
                className="w-full py-2.5 px-4 bg-gradient-to-r from-rose-700 to-red-600 hover:from-rose-600 hover:to-red-500 text-white border border-rose-400/40 rounded-xl font-bold text-xs tracking-wider transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
