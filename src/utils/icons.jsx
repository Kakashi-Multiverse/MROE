...
export const ShieldIcon = ({ className = "w-5 h-5 text-emerald-400" }) => (
...
export const ZapIcon = ({ className = "w-5 h-5 text-amber-400" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
  </svg>
);

export const AlertIcon = ({ className = "w-6 h-6 text-red-500 animate-bounce" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
